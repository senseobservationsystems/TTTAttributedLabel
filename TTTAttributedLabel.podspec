Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/senseobservationsystems/TTTAttributedLabel'
  s.platform     = :ios
  s.summary      = 'A drop-in replacement for UILabel that supports attributes, data detectors, links, and more.'
  s.source       = { :git => 'https://github.com/senseobservationsystems/TTTAttributedLabel.git', :tag => s.version.to_s }
  s.license      = 'MIT'
